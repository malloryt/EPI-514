...
total_N_unweighted = nrow(BRFSS_merged)


w_n_table = svytable(~COV_YEAR,design=design)
u_n_table = table(BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$SEX,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$SEX)
...
u_n_table = table(BRFSS_merged$AGEG20YR,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$AGEG20YR)
...
u_n_table = table(BRFSS_merged$X_RACE,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$X_RACE)
...
u_n_table = table(BRFSS_merged$X_URBSTAT,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$X_URBSTAT)
...
u_n_table = table(BRFSS_merged$EMPLOY1,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$EMPLOY1)
...
u_n_table = table(BRFSS_merged$INCOME2,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$INCOME2)
...
u_n_table = table(BRFSS_merged$RENTHOM1,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$RENTHOM1)
...
u_n_table = table(BRFSS_merged$X_EDUCAG,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$X_EDUCAG)
...
u_n_table = table(BRFSS_merged$SO,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$SO)
...
u_n_table = table(BRFSS_merged$TRNSGNDR,BRFSS_merged$COV_YEAR)
...
u_n_table = table(BRFSS_merged$TRNSGNDR)
