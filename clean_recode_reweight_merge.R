...
variables = c("X_STATE","FMONTH","IDATE","IYEAR","DISPCODE","SEQNO","X_PSU",
              ...
              "HIVTST6","HIVTSTD3","X_MRACE1","X_HISPANC")
...
variables = c("X_STATE","FMONTH","IDATE","IYEAR","DISPCODE","SEQNO","X_PSU",
              ...
              "INCOME2","RENTHOM1","X_EDUCAG","X_URBSTAT","SOMALE","SOFEMALE",
              "TRNSGNDR","MEDCOST","HLTHPLN1","HIVTST6","HIVTSTD3","X_MRACE1","X_HISPANC")
...
# Race category #
  # Values above 7 indicate Don't know/Refused/Missing
BRFSS_merged$X_MRACE1[BRFSS_merged$X_MRACE1 >7 ] <- NA

# Hispanic ethnicity category #
  #Values of 9 indicate Don't know/Refused/Missing
BRFSS_merged$X_HISPANC[BRFSS_merged$X_HISPANC == 9] <- NA
